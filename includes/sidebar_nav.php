...
$navItems = [
    ...
    ['href' => 'admin_reports.php','icon'=> 'bi-bar-chart-line',  'label' => 'Attendance Reports',
     'roles' => ['admin']],
    ['href' => 'admin_reports_center.php','icon'=> 'bi-graph-up-arrow', 'label' => 'Reports Center',
     'roles' => ['admin']],
    ['href' => 'admin_media.php', 'icon' => 'bi-folder2-open',    'label' => 'Media Manager',
     'roles' => ['admin']],
    ...
    ['href' => 'admin_locations.php', 'icon' => 'bi-geo-alt-fill',   'label' => 'Location Tracker',
     'roles' => ['admin']],
    ['href' => 'leads.php',           'icon' => 'bi-person-lines-fill','label' => 'Leads',
     'roles' => ['admin','office_staff','field_worker']],
    ...
    ['href' => 'data_purge.php',      'icon' => 'bi-trash3',         'label' => 'Data Maintenance',
     'roles' => ['admin']],
    ['href' => 'admin_system_monitor.php', 'icon' => 'bi-activity',  'label' => 'System Monitor',
     'roles' => ['admin']],
];
?>
<!-- User profile pill -->
